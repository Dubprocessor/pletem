  ...
  prices: {
    tabs: {
      ...
      ["Классические косички"]:
        "Классические косы являются наиболее распространенными. Плетение производится вручную из трех прядей по всей длине волос. Чем тоньше пряди, тем прочнее прическа. В среднем, для этой прически делается около 200-250 косичек, но их количество может доходить до 600. Если Вам кажется, что у Вас не достаточно густые волосы, Вы можете легко изменить свою прическу, выбрав классические африканские косички с канекалоном. Косички могут быть любой длины. Вы можете носить классические африканские косички до двух месяцев.",
      ["Ганские косички"]:
