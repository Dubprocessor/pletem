...
export const siteData: SiteData = {
  prices: {
    tabs: {
      ...
      ["Ганские косички"]: `Ганские косы обычно выбирают спортсменки, танцовщицы, или просто занятые девушки, у которых нет возможности часто заботиться о своей прическе. А также этот вид косичек наиболее частый выбор среди мучжин. В нашей стране их обычно называют френчами или просто брейдами.  Эти косички носят не более одного месяца. Перед повторным плетением волосам дают отдохнуть несколько недель.`,
