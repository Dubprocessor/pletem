        ...
        <header className="header">
          ...
          <nav id="menu" className="header__nav">
            ...
            <a
              ...
              href={`${props.mod === "index" ? "./" : "../../"}pages/about`}
            >
              Обо мне
            </a>{" "}
            <a
              className="header__link"
              href={`${props.mod === "index" ? "./" : "../../"}pages/gallery`}
            >
              Галерея
            </a>{" "}
            <a
            ...
            <a
              className="header__link"
              href={`${props.mod === "index" ? "./" : "../../"}pages/prices`}
            >
              Цены
            </a>{" "}
            <a
              className="header__link"
              href={`${props.mod === "index" ? "./" : "../../"}pages/contacts`}
            >
              Контакты
            </a>{" "}
            <a
              className="header__link"
              href={`${props.mod === "index" ? "./" : "../../"}pages/faq`}
            >
              Вопросы
            </a>{" "}
          </nav>
